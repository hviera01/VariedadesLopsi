...
class _IngresosEgresosScreenState extends ConsumerState<IngresosEgresosScreen> {
            ...
            children: [
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(foregroundColor: const Color(0xFFFFE000), side: const BorderSide(color: Color(0xFFB6BCC7)), padding: const EdgeInsets.symmetric(vertical: 13), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
                ),
              ),
              ...
              Expanded(
                child: FilledButton.icon(
                  ...
                  style: FilledButton.styleFrom(backgroundColor: const Color(0xFFFFE000), padding: const EdgeInsets.symmetric(vertical: 13), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
                ),
              ),
            ],
          ),
  ...
  Widget _totalesFila(TotalesLibro totales, bool esMovil) {
    return Wrap(
      ...
      children: [
        ...
        _statChip('Gastos negocio', totales.gastosNegocio, const Color(0xFFFFE000)),
  ...
  Widget _lista(List<MovimientoFinanciero> lista) {
    if (_cargando) return const Center(child: CircularProgressIndicator(color: Color(0xFFFFE000)));
    if (lista.isEmpty) {
      return Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(flex: 2, child: Text(m.egreso == 0 ? '' : formatearMoneda(m.egreso), style: GoogleFonts.poppins(fontSize: 12, color: const Color(0xFFFFE000), fontWeight: FontWeight.w600))),
