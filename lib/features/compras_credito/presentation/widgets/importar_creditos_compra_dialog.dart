        ...
        if (_filas != null) ...[
          ...
          Wrap(
            ...
            children: [
              ...
              if (_conError.isNotEmpty) _badge('${_conError.length} con error (se omiten)', const Color(0xFFCA8A04)),
            ],
          ),
          const SizedBox(height: 14),
          _tablaPrevia(),
      ...
      child: SingleChildScrollView(
        child: Column(
          children: filas.map((f) {
            final color = f.valido ? const Color(0xFF1A1A1A) : const Color(0xFFCA8A04);
            return Container(
                      ...
                      children: [
                        ...
                        Text(
                          f.valido
                              ...
                              : f.error!,
                          style: GoogleFonts.poppins(fontSize: 11.5, color: f.valido ? Colors.grey.shade600 : const Color(0xFFCA8A04)),
                        ),
                      ],
                    ),
                  ),
