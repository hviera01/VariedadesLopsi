    ...
    doc.addPage(
      pw.MultiPage(
        ...
        header: (context) => pw.Column(
          ...
          children: [
            pw.Text('Reporte de Ventas', style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold, color: PdfColor.fromInt(0xFFCA8A04))),
        ...
        build: (context) => [
          pw.TableHelper.fromTextArray(
            ...
            headerDecoration: const pw.BoxDecoration(color: PdfColor.fromInt(0xFFCA8A04)),
    ...
    doc.addPage(
      pw.MultiPage(
        ...
        header: (context) => pw.Column(
          crossAxisAlignment: pw.CrossAxisAlignment.start,
          children: [
            pw.Text('Reporte de Compras', style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold, color: PdfColor.fromInt(0xFFCA8A04))),
            pw.SizedBox(height: 4),
            pw.Text('Total de registros: ${lista.length}', style: const pw.TextStyle(fontSize: 10, color: PdfColors.grey700)),
            pw.SizedBox(height: 14),
          ],
