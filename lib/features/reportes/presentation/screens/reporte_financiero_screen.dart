        ...
        builder: (context, constraints) {
          ...
          return Column(
            ...
            children: [
              ...
              if (_cargando) const Expanded(child: Center(child: CircularProgressIndicator(color: Color(0xFFCA8A04)))),
        ...
        children: [
          Container(
            ...
            child: TabBar(
              ...
              indicatorColor: const Color(0xFFCA8A04),
    ...
    return Wrap(
      ...
      children: [
        ...
        FilledButton.icon(
          ...
          style: FilledButton.styleFrom(backgroundColor: const Color(0xFFCA8A04), padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 14), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
        ),
      ],
    );
  }
