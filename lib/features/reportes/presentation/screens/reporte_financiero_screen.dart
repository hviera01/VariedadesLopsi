        ...
        builder: (context, constraints) {
          ...
          return Column(
            ...
            children: [
              ...
              if (_cargando) const Expanded(child: Center(child: CircularProgressIndicator(color: Color(0xFFFFE000)))),
      ...
      child: Column(
        children: [
          Container(
            ...
            child: TabBar(
              isScrollable: true,
              labelColor: const Color(0xFFFFE000),
              unselectedLabelColor: Colors.grey.shade600,
              indicatorColor: const Color(0xFFFFE000),
    ...
    return Wrap(
      ...
      children: [
        ...
        FilledButton.icon(
          ...
          style: FilledButton.styleFrom(backgroundColor: const Color(0xFFFFE000), padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 14), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
        ),
      ],
    );
  }
