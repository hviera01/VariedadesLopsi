...
const colorVentasFinanciero = Color(0xFFCA8A04);
const colorComprasFinanciero = Color(0xFFF59E0B);
const _paletaUsuarios = [Color(0xFFCA8A04), Color(0xFF0EA5A4), Color(0xFF3B82F6), Color(0xFF8B5CF6), Color(0xFFEC4899), Color(0xFF22C55E)];
...
Widget seccionUtilidad(ReporteFinancieroData data, bool esMovil) {
  ...
  final filaNeta = Wrap(
    ...
    children: [
      ...
      _flechaOperacion(Icons.drag_handle),
      _stat('Utilidad Neta', data.utilidadNeta, data.utilidadNeta >= 0 ? const Color(0xFF16A34A) : const Color(0xFFCA8A04)),
    ],
  );
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: Text(formatearMoneda(v.ganancia), textAlign: TextAlign.right, style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w700, color: v.ganancia >= 0 ? const Color(0xFF16A34A) : const Color(0xFFCA8A04)))),
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              width: double.infinity,
              padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 14),
              decoration: BoxDecoration(color: flujo.neto >= 0 ? const Color(0xFF16A34A) : const Color(0xFFCA8A04), borderRadius: BorderRadius.circular(14)),
              child: Row(
...
Widget seccionBalanceGeneral(ReporteFinancieroData data, bool esMovil) {
  ...
  final pasivosYPatrimonio = _tarjeta(
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('PASIVOS Y PATRIMONIO', style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w700, color: const Color(0xFFCA8A04), letterSpacing: 0.4)),
        const SizedBox(height: 10),
