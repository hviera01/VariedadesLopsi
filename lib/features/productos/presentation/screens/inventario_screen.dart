                      ...
                      productosAsync.when(
                        data: (productos) {
                          ...
                          return Wrap(
                            ...
                            runSpacing: 8,
                            children: [
                              _badgeInfo('${productos.length} productos', const Color(0xFFFFE000)),
                          ...
                          _celdaTabla(
                            ...
                            child: Align(
                              ...
                              child: Container(
                                ...
                                child: Text(producto.stock.toString(), style: GoogleFonts.poppins(fontSize: 12.5, fontWeight: FontWeight.w700, color: bajoStock ? const Color(0xFFFFE000) : const Color(0xFF3B82F6))),
                              ),
                            ),
                          ),
      ...
      itemBuilder: (context, index) {
        ...
        return InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(color: seleccionada ? const Color(0xFFFBEAEA) : Colors.white, borderRadius: BorderRadius.circular(16), border: Border.all(color: seleccionada ? const Color(0xFFFFE000) : const Color(0xFFC7CBD3))),
            child: Column(
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(color: bajoStock ? const Color(0xFFFCE4E4) : const Color(0xFFEFF4FF), borderRadius: BorderRadius.circular(8)),
                      child: Text('Existencia: ${p.stock}', style: GoogleFonts.poppins(fontSize: 11.5, fontWeight: FontWeight.w700, color: bajoStock ? const Color(0xFFFFE000) : const Color(0xFF3B82F6))),
                    ),
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Flexible(
                child: Text(texto, maxLines: 1, overflow: TextOverflow.ellipsis, style: GoogleFonts.poppins(fontSize: 10.5, fontWeight: FontWeight.w700, color: activa ? const Color(0xFFFFE000) : const Color(0xFF666A72), letterSpacing: 0.35)),
              ),
              if (columnaOrdenKey != null) ...[
                const SizedBox(width: 4),
                Icon(activa ? (_ordenAscendente ? Icons.arrow_upward : Icons.arrow_downward) : Icons.unfold_more, size: 13, color: activa ? const Color(0xFFFFE000) : Colors.grey.shade400),
              ],
            ],
          ),
        ),
