                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(subio ? Icons.arrow_upward : Icons.arrow_downward, size: 15, color: subio ? const Color(0xFF16A34A) : const Color(0xFFCA8A04)),
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      ...
                                      child: Row(
                                        children: [
                                          Icon(subio ? Icons.arrow_upward : Icons.arrow_downward, size: 13, color: subio ? const Color(0xFF16A34A) : const Color(0xFFCA8A04)),
