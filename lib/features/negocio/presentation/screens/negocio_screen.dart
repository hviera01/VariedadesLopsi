...
class _NegocioFormState extends ConsumerState<_NegocioForm> {
  ...
  Widget _tituloSeccion(String texto, IconData icono) {
    return Row(
      children: [
        Icon(icono, size: 19, color: const Color(0xFFCA8A04)),
    ...
    return _tarjeta(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          if (_error != null) ...[
            Text(_error!, style: GoogleFonts.poppins(fontSize: 12.5, color: const Color(0xFFCA8A04))),
              ...
              if (tieneClave)
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(foregroundColor: const Color(0xFFCA8A04), side: const BorderSide(color: Color(0xFFF3B9B9)), padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 14), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
      ...
      child: Row(
        ...
        children: [
          ...
          Switch(
            ...
            activeThumbColor: const Color(0xFFCA8A04),
          ),
        ],
      ),
    );
