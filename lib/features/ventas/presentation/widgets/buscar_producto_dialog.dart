  ...
  Widget _encabezadoOrdenable(String texto, String clave, TextStyle estilo) {
    ...
    return InkWell(
      ...
      child: Row(
        ...
        children: [
          Text(texto, style: activo ? estilo.copyWith(color: const Color(0xFFFFC107)) : estilo),
          const SizedBox(width: 3),
          Icon(
            activo ? (_ordenAscendente ? Icons.arrow_upward : Icons.arrow_downward) : Icons.unfold_more,
            size: 14,
            color: activo ? const Color(0xFFFFC107) : Colors.grey.shade400,
          ),
        ],
      ),
    );
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w600, color: bajoStock ? const Color(0xFFFFC107) : const Color(0xFF1E9E5A)),
                    ),
                  ),
                ),
              ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.poppins(fontSize: 11.5, fontWeight: FontWeight.w600, color: bajoStock ? const Color(0xFFFFC107) : const Color(0xFF1E9E5A)),
                    ),
                  ),
                ],
              ),
