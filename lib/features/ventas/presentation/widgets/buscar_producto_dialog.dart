  ...
  Widget _encabezadoOrdenable(String texto, String clave, TextStyle estilo) {
    ...
    return InkWell(
      ...
      child: Row(
        ...
        children: [
          Text(texto, style: activo ? estilo.copyWith(color: const Color(0xFFCA8A04)) : estilo),
          const SizedBox(width: 3),
          Icon(
            activo ? (_ordenAscendente ? Icons.arrow_upward : Icons.arrow_downward) : Icons.unfold_more,
            size: 14,
            color: activo ? const Color(0xFFCA8A04) : Colors.grey.shade400,
          ),
        ],
      ),
    );
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: seleccionada ? Border.all(color: const Color(0xFFCA8A04), width: 1.4) : Border.all(color: Colors.transparent, width: 1.4),
          ),
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w600, color: bajoStock ? const Color(0xFFCA8A04) : const Color(0xFF1E9E5A)),
                    ),
                  ),
                ),
              ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.poppins(fontSize: 11.5, fontWeight: FontWeight.w600, color: bajoStock ? const Color(0xFFCA8A04) : const Color(0xFF1E9E5A)),
                    ),
                  ),
                ],
              ),
