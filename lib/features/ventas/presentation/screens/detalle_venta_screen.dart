...
class _DetalleVentaScreenState extends ConsumerState<DetalleVentaScreen> {
  ...
  Widget _bannerAnulada(VentaModel venta, DateFormat formatoDia) {
    return Container(
      ...
      decoration: BoxDecoration(color: const Color(0xFFFCE4E4), borderRadius: BorderRadius.circular(14), border: Border.all(color: const Color(0xFFFFE000))),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Icon(Icons.block_outlined, color: Color(0xFFFFE000)),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Esta venta está anulada', style: GoogleFonts.poppins(fontSize: 13.5, fontWeight: FontWeight.w700, color: const Color(0xFFFFE000))),
    ...
    Widget opcion(String texto, bool valor) {
      ...
      return InkWell(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(color: activo ? const Color(0xFFFFE000) : Colors.transparent, borderRadius: BorderRadius.circular(10)),
